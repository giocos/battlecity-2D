...
public class ImageProvider {
	...
	private static final int MAPS_XY = 175;
	private static final int STAGE_X = 90;
	private static final int STAGE_Y = 20;
	...
	static {
		try {
			maps1P.add((ImageIO.read(new File("resources/map1.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map2.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map3.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map4.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map5.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map6.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map7.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map8.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map9.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map10.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map11.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map12.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map13.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map14.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map15.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map16.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map17.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map18.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map19.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map20.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map21.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map22.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map23.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps1P.add((ImageIO.read(new File("resources/map24.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map1_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map2_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map3_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map4_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map5_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map6_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map7_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map8_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map9_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map10_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map11_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map12_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map13_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map14_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map15_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map16_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map17_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map18_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map19_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map20_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map21_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map22_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map23_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			maps2P.add((ImageIO.read(new File("resources/map24_Multi.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
//			maps1P.add((ImageIO.read(new File("resources/mapBonus.png")).getScaledInstance(getMapsXY(), getMapsXY(),
//					java.awt.Image.SCALE_SMOOTH)));
//			maps2P.add((ImageIO.read(new File("resources/mapBonus_Multi.png")).getScaledInstance(getMapsXY(), getMapsXY(),
//			java.awt.Image.SCALE_SMOOTH)));
			
			setGameOver(ImageIO.read(new File("resources/gameOver.png")));
			setStageComplete(ImageIO.read(new File("resources/stageComplete.png")));
			setLocked((ImageIO.read(new File("resources/locked.png")).getScaledInstance(getMapsXy(), getMapsXy(),
					java.awt.Image.SCALE_SMOOTH)));
			setBackground1P((ImageIO.read(new File("resources/player1A.png")).getScaledInstance(600, 600,
					java.awt.Image.SCALE_SMOOTH)));
			setBackground1Px((ImageIO.read(new File("resources/player1A.png")).getScaledInstance(750, 750,
					java.awt.Image.SCALE_SMOOTH)));
			setBackground2P((ImageIO.read(new File("resources/player2A.png")).getScaledInstance(750, 750,
					java.awt.Image.SCALE_SMOOTH)));
			setTitle(ImageIO.read(new File("resources/title.png")));
			setCursorRight((ImageIO.read(new File("resources/cursorRight.gif")).getScaledInstance(38, 40,
					java.awt.Image.SCALE_SMOOTH)));
			setCursorLeft((ImageIO.read(new File("resources/cursorLeft.gif")).getScaledInstance(38, 40,
					java.awt.Image.SCALE_SMOOTH)));
			setSelectMap((ImageIO.read(new File("resources/selectMap.png")).getScaledInstance(186, 186,
					java.awt.Image.SCALE_SMOOTH)));
			setLoading(ImageIO.read(new File("resources/loading.gif")));
			setEasy((ImageIO.read(new File("resources/easy.png")).getScaledInstance(54, 20,
					java.awt.Image.SCALE_SMOOTH)));
			setNormal((ImageIO.read(new File("resources/normal.png")).getScaledInstance(72, 20,
					java.awt.Image.SCALE_SMOOTH)));
			setHard((ImageIO.read(new File("resources/hard.png")).getScaledInstance(52, 20,
					java.awt.Image.SCALE_SMOOTH)));
			setSound((ImageIO.read(new File("resources/sound.png")).getScaledInstance(78, 24,
					java.awt.Image.SCALE_SMOOTH)));
			setBattleCity(ImageIO.read(new File("resources/battleCity.png")));
			setPause((ImageIO.read(new File("resources/pause.png")).getScaledInstance(140, 50,
					java.awt.Image.SCALE_SMOOTH)));
			setGrenade((ImageIO.read(new File("resources/grenade.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setHelmet((ImageIO.read(new File("resources/helmet.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			
			//non cancellare
			setHelmetx((ImageIO.read(new File("resources/helmet.png")).getScaledInstance(50, 50,
					java.awt.Image.SCALE_SMOOTH)));
			setTimerx((ImageIO.read(new File("resources/timer.png")).getScaledInstance(50, 50,
					java.awt.Image.SCALE_SMOOTH)));
			setShovelx((ImageIO.read(new File("resources/shovel.png")).getScaledInstance(50, 50,
					java.awt.Image.SCALE_SMOOTH)));
			
			setKeyboard((ImageIO.read(new File("resources/keyboard.png"))));
			
			setShovel((ImageIO.read(new File("resources/shovel.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setStar((ImageIO.read(new File("resources/star.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setTimer((ImageIO.read(new File("resources/timer.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setTank((ImageIO.read(new File("resources/tank.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer1A((ImageIO.read(new File("resources/player1A.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer1B((ImageIO.read(new File("resources/player1B.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer1A_s1((ImageIO.read(new File("resources/player1A_s1.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer1B_s1((ImageIO.read(new File("resources/player1B_s1.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer1A_s2((ImageIO.read(new File("resources/player1A_s2.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer1B_s2((ImageIO.read(new File("resources/player1B_s2.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer1A_s3((ImageIO.read(new File("resources/player1A_s3.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer1B_s3((ImageIO.read(new File("resources/player1B_s3.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer2A((ImageIO.read(new File("resources/player2A.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer2B((ImageIO.read(new File("resources/player2B.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer2A_s1((ImageIO.read(new File("resources/player2A_s1.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer2B_s1((ImageIO.read(new File("resources/player2B_s1.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer2A_s2((ImageIO.read(new File("resources/player2A_s2.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer2B_s2((ImageIO.read(new File("resources/player2B_s2.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer2A_s3((ImageIO.read(new File("resources/player2A_s3.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setPlayer2B_s3((ImageIO.read(new File("resources/player2B_s3.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setWaterA((ImageIO.read(new File("resources/waterA.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setWaterB((ImageIO.read(new File("resources/waterB.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setIce((ImageIO.read(new File("resources/ice.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setBrick((ImageIO.read(new File("resources/brick.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setSteel((ImageIO.read(new File("resources/steel.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
			setTree((ImageIO.read(new File("resources/tree.png")).getScaledInstance(getTile(), getTile(),
					java.awt.Image.SCALE_SMOOTH)));
