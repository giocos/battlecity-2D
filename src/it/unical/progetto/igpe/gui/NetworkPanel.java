...
public class NetworkPanel extends JPanel {
	...
	private static final String DEFAULT_PORT_CHAT = "1232";
	...
	private void createLabels() {
		...
		ipTextField.setText(DEFAULT_IP);
		...
		case 4: // LOBBY
			buttons.get(j).addActionListener(e -> {
				...
				if (nameTextField.getText().equals(defaultName)) {
					...
					serverChat = new Server(Integer.parseInt(DEFAULT_PORT_CHAT));
					new Thread(serverChat, "chat").start();
					client = new ClientChatPanel(nameTextField.getText(), ipTextField.getText(), Integer.parseInt(DEFAULT_PORT_CHAT), ((MainFrame)getSwitcher()));
					nameTextField.setText(defaultName);
				}
			});
			break;
